...
public class SplashScreenFramePart extends FramePart {
    ...
    public SplashScreenFramePart(Vector2i position, Vector2i size, String path) {
    ...
    public SplashScreenFramePart(Vector2i position, Vector2i size) {
        super(FramePartType.GUI);
        this.position = position;
        this.size = size;
    }
